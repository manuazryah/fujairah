...
$this->params['breadcrumbs'][] = ['label' => ' Cash in Hand', 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
$credit_total = CashInHand::getTotal($dataProvider->getModels(), 1);
$debit_total = CashInHand::getTotal($dataProvider->getModels(), 2);
?>
                ...
                GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'label' => 'Employee',
                            'value' => function($data) {
                                return Employee::findOne($data->employee_id)->name;
                            },
                            'filter' => ArrayHelper::map(Employee::find()->asArray()->all(), 'id', 'name'),
                            'filterOptions' => array('id' => "employee_name_search"),
                        ],
                        [
                    ...
                    <table cellspacing="0" class="table table-small-font table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th data-priority="6" >Cheque No</th>
                        ...
                        <tbody>
                            <tr class="filter">
                                ...
                                <td>
                                    ...
                                    ?>
                                    <?php // $form->field($model, 'date')->textInput(['placeholder' => 'Date'])->label(false)     ?>
                                </td>
...
<script>
                    $(document).ready(function () {
                        $("#cashinhand-check_no").prop("disabled", true);
                        $('#cashinhand-payment_type').change(function () {
                            var payment_id = $(this).val();
                            if (payment_id == 2) {
                                $("#cashinhand-check_no").prop("disabled", false);
                            } else {
                                $("#cashinhand-check_no").prop("disabled", true);
                            }
                        });
