...
/**
 * MasterSubServiceSearch represents the model behind the search form about `common\models\MasterSubService`.
 */
class MasterSubServiceSearch extends MasterSubService
{
    /**
     * @inheritdoc
     */
